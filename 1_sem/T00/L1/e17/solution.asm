asect  0x00               # Start a new section at memory address 0x00
    ...
    dec r1                # Decrement the value in r1 by 1 (r1 = r1 - 1)

    ldi r2, b             # Load the address of label 'b' into register r2
    st r2, r1             # Store the decremented value in r1 into memory address 'b'
...
a:
  dc "P"                  # Define the ASCII value of character 'P' (which is 80 in decimal) at label 'a'
b:
